...
<p className="my-[14px] mb-[26px] max-w-[420px] text-[16.5px] text-dim">
Whether you need a website, funnel, CRM automation, or a complete GoHighLevel setup, I&apos;d love to help
bring your project to life.
</p>
<a href="https://calendar.app.google/uGboPxZ85sW2tMBa9" target="_blank" rel="noopener noreferrer" className="grad-bg inline-block rounded-md px-[26px] py-[14px] font-display text-[14px] font-semibold uppercase tracking-[0.14em] text-white transition hover:-translate-y-px hover:brightness-110">
...
const inner = (
<>
<span className="flex h-[34px] w-[34px] flex-shrink-0 items-center justify-center rounded-full border border-border text-[15px] text-foreground">
{contact.icon}
</span>
...
return (
<li key={contact.text} className="flex items-center gap-3 text-[16px] text-dim">
{contact.href ? (
...
<div className="flex flex-wrap items-center justify-between gap-3 border-t border-border pt-[26px] text-[14px] text-faint">
