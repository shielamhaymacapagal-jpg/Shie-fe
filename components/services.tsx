      ...
      <div className="mx-auto max-w-[1200px] px-8">
        ...
        <div className="grid grid-cols-1 gap-[18px] sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {SERVICES.map((service) => (
            <div
              key={service.title}
              className="rounded-card border border-border bg-card px-[22px] py-[26px] transition duration-[250ms] hover:-translate-y-[3px] hover:border-purple-light hover:shadow-[0_16px_40px_rgba(147,51,234,0.15)]"
            >
